...
for jj in range (int(240*event_start), int(240*(event_start+1))):
    if (sqrt( (fpsx[ii,jj+1] - fpsx[ii,jj])**2 + (fpsy[ii,jj+1] - fpsy[ii,jj])**2 ) < 200.0):
        ax.plot( (fpsx[ii,jj], fpsx[ii,jj+1]), (fpsy[ii,jj], fpsy[ii,jj+1]), linewidth=1, linestyle='-', color='black', alpha=step_alpha*(jj-240*event_start), aa=True)
...
for jj in range (int(240*event_start), int(240*(event_start+1))):
    if (sqrt( (fpsx[ii,jj+1] - fpsx[ii,jj])**2 + (fpsy[ii,jj+1] - fpsy[ii,jj])**2 ) < 200.0):
        ax.plot( (fpsx[ii,jj], fpsx[ii,jj+1]), (fpsy[ii,jj], fpsy[ii,jj+1]), linewidth=1, linestyle='-', color='red', alpha=step_alpha*(jj-240*event_start), aa=True)
...
for jj in range (int(240*event_start), int(240*(event_start+1))):
    if (sqrt( (fpsx[ii,jj+1] - fpsx[ii,jj])**2 + (fpsy[ii,jj+1] - fpsy[ii,jj])**2 ) < 200.0):
        ax.plot( (fpsx[ii,jj], fpsx[ii,jj+1]), (fpsy[ii,jj], fpsy[ii,jj+1]), linewidth=1, linestyle='-', color='green', alpha=step_alpha*(jj-240*event_start), aa=True)
...
for jj in range (int(240*event_start), int(240*(event_start+1))):
    if (sqrt( (fpsx[ii,jj+1] - fpsx[ii,jj])**2 + (fpsy[ii,jj+1] - fpsy[ii,jj])**2 ) < 200.0):
        ax.plot( (fpsx[ii,jj], fpsx[ii,jj+1]), (fpsy[ii,jj], fpsy[ii,jj+1]), linewidth=1, linestyle='-', color='blue', alpha=step_alpha*(jj-240*event_start), aa=True)
