...
ax[0].plot(time[240*event_start:240*(event_start+duration)]-event_start, ratio[ii,240*event_start:240*(event_start+duration)]+lindex*(1+epad), linestyle='--', linewidth=1, color='white', aa=True, zorder=2)
#######################################
...
ax[0].fill_between(time[240*event_start:240*(event_start+duration)]-event_start, suitability[ii,240*event_start:240*(event_start+duration)]+lindex*(1+epad), lindex*(1+epad), facecolor=[1.0,1.0,1.0,0.5], edgecolor='none',  zorder=1)
...
ax[0].plot(time[240*event_start:240*(event_start+duration)]-event_start, residence[ii,240*event_start:240*(event_start+duration)]+lindex*(1+epad), linestyle='-', linewidth=1, color='white', aa=True, zorder=2)
lindex=lindex-1
print
...
ax[0].text(x=0.05, y=3.75, s='Control (A)', color='white', fontsize=fontsize)
...
plt.savefig('./fish_singlecues_screen.tiff', facecolor=bg_color, edgecolor='none', dpi=default_dpi)
