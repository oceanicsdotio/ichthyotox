...
ax[0].plot(time, ratio_avg, linestyle='-', linewidth=1, color='black', aa=True, label='Control (A)', zorder=5)
...
ax[0].set_ylabel('Carbon Ratio (g/g) ', rotation=90)
...
#plt.show()
plt.savefig('./cyano_ratio_single.tiff', facecolor=bg_color, edgecolor='none', dpi=default_dpi)
