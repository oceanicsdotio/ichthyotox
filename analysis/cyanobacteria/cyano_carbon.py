...
totalc = (protein + carbohydrate)/volume
...
ax[0].fill_between(time, (sum_avg+sum_std), (sum_avg-sum_std), facecolor=[0.0,0.0,0.0,0.25], edgecolor='none', zorder=3)
...
#plt.show()
plt.savefig('./cyano_carbon_single.tiff', facecolor=bg_color, edgecolor='none', dpi=default_dpi)
