...
ax[0].plot(time, ratio_sum[:]+lindex*(1+epad), linestyle='-', linewidth=1, color='white', aa=True, label='Control (A)', zorder=2)
lindex=lindex-1
for ii in range(0,nsamples):
    ax[0].plot(time, ratio[pindex[ii],:]+lindex*(1+epad), linestyle='-', linewidth=1, color='white', aa=True, zorder=2)
    lindex=lindex-1
#######################################
...
lindex = lindex+5
ax[0].fill_between(time, suit_sum[:]+lindex*(1+epad), lindex*(1+epad), facecolor=[1.0,1.0,1.0,0.5], edgecolor='none',  zorder=1)
lindex=lindex-1
for ii in range(0,nsamples):
    ax[0].fill_between(time, suitability[pindex[ii],:]+lindex*(1+epad), lindex*(1+epad), facecolor=[1.0,1.0,1.0,0.5], edgecolor='none',  zorder=1)
    lindex=lindex-1
#######################################
...
ax[0].text(x=0.05*30, y=21.25, s='Control (A)', color='white', fontsize=fontsize)
...
plt.savefig('./fish_cues_screen.tiff', facecolor=bg_color, edgecolor='none', dpi=default_dpi)
