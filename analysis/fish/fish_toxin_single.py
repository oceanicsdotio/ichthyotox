...
ax[0].fill_between(time, 1000*(ratio_avg-ratio_std), 1000*(ratio_avg+ratio_std), facecolor=[1.0,0.0,0.0,0.25], edgecolor='none', zorder=2)
#######################################
...
ax[0].fill_between(time, 1000*(ratio_avg-ratio_std), 1000*(ratio_avg+ratio_std), facecolor=[0.0,1.0,0.0,0.25], edgecolor='none', zorder=1)
...
ratio_avg1 = np.mean(ratio[0:nfish/2-1,:], axis=0)
ratio_avg2 = np.mean(ratio[nfish/2:nfish-1,:], axis=0)
ax[0].fill_between(time, 1000*(ratio_avg-ratio_std), 1000*(ratio_avg+ratio_std), facecolor=[0.0,0.0,1.0,0.25], edgecolor='none', zorder=3)
...
ax[0].plot((time[start], time[end]),(0.005, 0.005), linestyle='--', linewidth=1, color='black', aa=True, zorder = 5)
ax[0].plot((time[start], time[end]),(0.015, 0.015), linestyle='--', linewidth=1, color='black', aa=True, zorder = 5)
...
ax[0].yaxis.set_minor_locator(MultipleLocator(0.002))
...
plt.savefig('./fish_toxin_single.tiff', facecolor=bg_color, edgecolor='none', dpi=default_dpi)
