...
ax[0].plot(time[start+window:end-window], suit_smoothed[start+window:end-window], linestyle='-', linewidth=1, color='black', aa=True, label='Control (A)',zorder=3)
...
ax[0].plot((time[start], time[end]),(0.5, 0.5), linestyle='--', linewidth=1, color='black', aa=True, zorder = 5)
...
#plt.show()
plt.savefig('./fish_suitability_color.tiff', facecolor=bg_color, edgecolor='none', dpi=default_dpi)
