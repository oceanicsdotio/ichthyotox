#!/usr/bin/python
from matplotlib.pyplot import figure, title, savefig, LinearLocator, FormatStrFormatter
from mpl_toolkits.mplot3d import Axes3D
from numpy import linspace, zeros, exp, log, meshgrid
...
temperature, rr1 = meshgrid(temperature, ratio, sparse=True)
density, rr2 = meshgrid(density, ratio, sparse=True)
visc, rr3 = meshgrid(visc, ratio, sparse=True)
...
savefig('./figures/bloom/hydrodynamics.png', facecolor=bg_color, edgecolor='none', dpi=default_dpi)