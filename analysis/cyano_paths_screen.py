...
ax[0].plot(time, z_avg, linestyle='-', linewidth=1, color='white', aa=True, label='Control (A)', zorder = 5)
#######################################
...
ax[0].set_ylabel('Mean Depth (m)', rotation=90)
...
plt.savefig('./cyano_paths_screen.tiff', facecolor=bg_color, edgecolor='none', dpi=default_dpi)
